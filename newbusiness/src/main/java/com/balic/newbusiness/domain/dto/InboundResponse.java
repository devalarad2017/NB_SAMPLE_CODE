...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "NB application response for external partner")
...
public class InboundResponse {
    ...
    private InboundRequest.PInList pInList1_inout;

    @JsonProperty("pInList2_inout")
    private InboundRequest.PInList pInList2_inout;

    @JsonProperty("pInList3_inout")
    private InboundRequest.PInList pInList3_inout;

    @JsonProperty("pInList4_inout")
    private InboundRequest.PInList pInList4_inout;

    @JsonProperty("pInList5_inout")
    private InboundRequest.PInList pInList5_inout;

    @JsonProperty("pInList6_inout")
    private InboundRequest.PInList pInList6_inout;

    @JsonProperty("pInList7_inout")
    private InboundRequest.PInList pInList7_inout;

    @JsonProperty("pInList8_inout")
    private InboundRequest.PInList pInList8_inout;

    @JsonProperty("pInList9_inout")
    private InboundRequest.PInList pInList9_inout;

    @JsonProperty("pInList10_inout")
    private InboundRequest.PInList pInList10_inout;
    ...
    public static class PInList {
        ...
        private List<InboundRequest.WeoRecStrings150User> weoRecStrings150User;
    }
    ...
    public Map<String, String> getParams() {
        ...
        addPrefixed(merged, "obj10", pInObj10_inout);
    ...
    private void addPrefixedList(Map<String, String> target, String prefix, InboundRequest.PInList listObj) {
        if (listObj == null) return;
        List<InboundRequest.WeoRecStrings150User> records = listObj.getWeoRecStrings150User();
    ...
    public InboundRequest.PInList getList1() {
        return pInList1_inout;
    }

    public InboundRequest.PInList getList4() {
        return pInList4_inout;
    }
    public InboundRequest.PInList getList5() {
        return pInList5_inout;
    }

    public InboundRequest.PInList getList6() {
    ...
    public InboundRequest.PInList getpInList7_inout() {
        return pInList7_inout;
    }

    public void setpInList7_inout(InboundRequest.PInList pInList7_inout) {
        this.pInList7_inout = pInList7_inout;
    }

    public InboundRequest.PInList getpInList8_inout() {
        return pInList8_inout;
    }

    public void setpInList8_inout(InboundRequest.PInList pInList8_inout) {
        this.pInList8_inout = pInList8_inout;
    }

    public InboundRequest.PInList getpInList9_inout() {
        return pInList9_inout;
    }

    public void setpInList9_inout(InboundRequest.PInList pInList9_inout) {
        this.pInList9_inout = pInList9_inout;
    }

    public InboundRequest.PInList getpInList10_inout() {
        return pInList10_inout;
    }

    public void setpInList10_inout(InboundRequest.PInList pInList10_inout) {
        this.pInList10_inout = pInList10_inout;
    }

    public InboundRequest.PInList getpInList2_inout() {
        return pInList2_inout;
    }

    public void setpInList2_inout(InboundRequest.PInList pInList2_inout) {
        this.pInList2_inout = pInList2_inout;
    }

    public InboundRequest.PInList getpInList3_inout() {
        return pInList3_inout;
    }

    public void setpInList3_inout(InboundRequest.PInList pInList3_inout) {
